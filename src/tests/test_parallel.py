...
def test_ray_import_error_when_missing() -> None:
    from graphatoms.parallel.backends import ray as ray_backend
...
def test_dask_import_error_when_missing() -> None:
    from graphatoms.parallel.backends import dask as dask_backend
...
def test_executorlib_import_error_when_missing() -> None:
    from graphatoms.parallel.backends import executorlib as el_backend
...
def test_example_batch_consume_cancel() -> None:
    from graphatoms.parallel.example import run_batch_consume_cancel
...
def test_example_batch_wait_cancel() -> None:
    from graphatoms.parallel.example import run_batch_wait_cancel
