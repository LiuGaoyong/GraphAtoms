# ruff: noqa
# copied from types-array-api:
#   https://github.com/34j/types-array-api/blob/main/src/array_api/_2024_12.py
...
class Info[TDevice](Protocol):
    ...
    def dtypes(
        self, *, device: TDevice | None, kind: str | tuple[str, ...] | None
    ) -> DataTypes: ...
...
class Array[TDtype, TDevice](Protocol):
    ...
    ) -> ArrayNamespace[Self, TDtype, TDevice]:
        """
    ...
    def __getitem__(
        ...
        | ellipsis
        | None
        | tuple[int | slice | ellipsis | Self | None, ...]
        | Self,
        /,
    ) -> Self:
        """
    ...
    def __setitem__(
        ...
        | slice
        | ellipsis
        | tuple[int | slice | ellipsis | Self, ...]
        | Self,
        value: int | float | complex | bool | Self,
        /,
    ) -> None:
        """
    ...
    def to_device(
        self, device: TDevice, /, *, stream: int | Any | None = None
    ) -> Self:
        """
...
class isdtype[TDtype](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, /, dtype: TDtype, kind: TDtype | str | tuple[TDtype | str, ...]
    ) -> bool: ...
...
class result_type[TArray: Array, TDtype](Protocol):
    ...
    def __call__(
        self,
        /,
        *arrays_and_dtypes: TArray | int | float | complex | bool | TDtype,
    ) -> TDtype: ...
...
class meshgrid[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, /, *arrays: TArray, indexing: Literal["xy", "ij"] = "xy"
    ) -> list[TArray]: ...
...
class cross[TArray: Array](Protocol):
    ...
    **Raises**
    ...
    @abstractmethod
    def __call__(
        self, x1: TArray, x2: TArray, /, *, axis: int = -1
    ) -> TArray: ...
...
class matrix_norm[TArray: Array](Protocol):
    ...
    def __call__(
        ...
        *,
        keepdims: bool = False,
        ord: int | float | Literal[inf, -inf, "fro", "nuc"] | None = "fro",  # type: ignore[valid-type]
    ) -> TArray:  # type: ignore[valid-type]
        ...
...
class matrix_rank[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, *, rtol: float | TArray | None = None
    ) -> TArray: ...
...
class qr[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, *, mode: Literal["reduced", "complete"] = "reduced"
    ) -> tuple[TArray, TArray]: ...
...
class svd[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, *, full_matrices: bool = True
...
class trace[TArray: Array, TDtype](Protocol):
    ...
    **Special Cases**
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, *, offset: int = 0, dtype: TDtype | None = None
    ) -> TArray: ...
...
class vector_norm[TArray: Array](Protocol):
    ...
    def __call__(
        ...
        *,
        axis: int | tuple[int, ...] | None = None,
        keepdims: bool = False,
        ord: int | float | Literal[inf, -inf] = 2,  # type: ignore[valid-type]
    ) -> TArray:  # type: ignore[valid-type]
        ...
...
class add[TArray: Array](Protocol):
    ...
    **Special cases**
    ...
    def __call__(
        self,
        x1: TArray | int | float | complex,
        x2: TArray | int | float | complex,
        /,
    ) -> TArray: ...
...
class atan2[TArray: Array](Protocol):
    ...
    **Special cases**
    ...
    @abstractmethod
    def __call__(
        self, x1: TArray | int | float, x2: TArray | int | float, /
    ) -> TArray: ...
...
class bitwise_and[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x1: TArray | int | bool, x2: TArray | int | bool, /
    ) -> TArray: ...
...
class clip[TArray: Array](Protocol):
    ...
    **Special cases**
    ...
    def __call__(
        ...
        x: TArray,
        /,
        min: int | float | TArray | None = None,
        max: int | float | TArray | None = None,
    ) -> TArray: ...
...
class equal[TArray: Array](Protocol):
    ...
    **Special Cases**
    ...
    def __call__(
        self,
        x1: TArray | int | float | complex | bool,
        x2: TArray | int | float | complex | bool,
        /,
    ) -> TArray: ...
...
class argmax[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, *, axis: int | None = None, keepdims: bool = False
    ) -> TArray: ...
...
class diff[TArray: Array](Protocol):
    ...
    def __call__(
        ...
        *,
        axis: int = -1,
        n: int = 1,
        prepend: TArray | None = None,
        append: TArray | None = None,
    ) -> TArray: ...
...
class take[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, indices: TArray, /, *, axis: int | None = None
    ) -> TArray: ...
...
class take_along_axis[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, indices: TArray, /, *, axis: int = -1
    ) -> TArray: ...
...
class fftshift[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, *, axes: int | Sequence[int] | None = None
    ) -> TArray: ...
...
class concat[TArray: Array](Protocol):
    ...
    def __call__(
        self,
        arrays: tuple[TArray, ...] | list[TArray],
        /,
        *,
        axis: int | None = 0,
    ) -> TArray: ...
...
class flip[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, *, axis: int | tuple[int, ...] | None = None
    ) -> TArray: ...
...
class repeat[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, repeats: int | TArray, /, *, axis: int | None = None
    ) -> TArray: ...
...
class reshape[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, /, shape: tuple[int, ...], *, copy: bool | None = None
    ) -> TArray: ...
...
class stack[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, arrays: tuple[TArray, ...] | list[TArray], /, *, axis: int = 0
    ) -> TArray: ...
...
class tile[TArray: Array](Protocol):
    ...
    @abstractmethod
    def __call__(
        self, x: TArray, repetitions: tuple[int, ...], /
    ) -> TArray: ...
...
class unique_all[TArray: Array](Protocol):
    ...
    def __call__(
        self, x: TArray, /
    ) -> tuple[TArray, TArray, TArray, TArray]: ...
...
@runtime_checkable
class ArrayNamespaceFull[TArray: Array, TDtype, TDevice](
    ArrayNamespace[TArray, TDtype, TDevice], Protocol
):
